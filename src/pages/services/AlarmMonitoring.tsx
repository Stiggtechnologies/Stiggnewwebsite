...
import { Bell, Shield, Clock, Wifi, Phone, AlertTriangle } from 'lucide-react';
import Button from '../../components/ui/Button';

const AlarmMonitoring: React.FC = () => {
  const services = [
    {
      title: "24/7 Monitoring",
      description: "Round-the-clock professional monitoring of your alarm systems",
      icon: <Clock className="h-6 w-6" />,
    },
    {
      title: "Rapid Response",
      description: "Swift emergency response to alarm triggers",
      icon: <Bell className="h-6 w-6" />,
    },
    {
      title: "Remote Access",
      description: "Secure remote system access and control",
      icon: <Wifi className="h-6 w-6" />,
    },
    {
      title: "Emergency Dispatch",
      description: "Coordinated emergency services dispatch",
      icon: <Phone className="h-6 w-6" />,
    },
    {
      title: "System Health Monitoring",
      description: "Continuous monitoring of alarm system status",
      icon: <Shield className="h-6 w-6" />,
    },
    {
      title: "Incident Response",
      description: "Professional handling of security incidents",
  ...
  return (
    <>
      <SEO {...SEO_CONFIG[\'/services/alarm-monitoring\']} />
    <div className="min-h-screen bg-white pt-20">
      {/* Hero Section */}
      <section className="relative py-20 bg-primary-950">
        <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/1550337/pexels-photo-1550337.jpeg')] bg-cover bg-center opacity-10"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-steel-300 mb-8">
              24/7 professional monitoring services keeping your property secure around the clock.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-steel-600">
              Comprehensive alarm monitoring solutions for your peace of mind.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-steel-600">
                      State-of-the-art monitoring systems and equipment.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-steel-600">
                      Trained monitoring specialists available 24/7.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-steel-600">
                      Immediate response to alarms and security breaches.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-lg">
                ...
                <p className="text-steel-600">Uptime guarantee</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="bg-primary-900 rounded-2xl p-12 text-center">
            ...
            <p className="text-xl text-steel-300 mb-8 max-w-2xl mx-auto">
              Get started with our professional alarm monitoring services today.
            </p>
